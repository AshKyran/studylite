  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await createNoteRecord({
        ...
        authorId: userId,           // CRITICAL: We pass the verified userId here!
        contentUrl: filePath,       // We store the path so we can generate Secure Signed URLs later
        thumbnailUrl: publicThumbData.publicUrl, // We store the public link for the image
      });
