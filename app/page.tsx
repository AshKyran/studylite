  ...
  return (
    <main className="flex flex-col min-h-screen bg-slate-50 font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-40 overflow-hidden bg-slate-950 border-b border-slate-800">
        ...
        {/* Clean, standard Tailwind ambient glows (No arbitrary values) */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-96 bg-indigo-600 opacity-20 blur-3xl rounded-full pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-600 opacity-10 blur-3xl rounded-full pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
          
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-slate-900 border border-slate-700 text-slate-300 font-medium text-xs sm:text-sm mb-8 shadow-lg">
            <span className="flex h-2 w-2 rounded-full bg-indigo-500 mr-3 animate-pulse"></span>
            The Global Nexus for Academic Excellence
          </div>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tight mb-8 leading-tight max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-5 w-full sm:w-auto">
            <Link 
              href="/register" 
              className="w-full sm:w-auto px-8 py-4 bg-white text-slate-950 font-bold rounded-2xl shadow-xl shadow-white/10 hover:scale-105 transition-all duration-300 text-lg flex items-center justify-center"
            >
              Enter the Ecosystem
      ...
      <section className="py-24 bg-white relative z-20 -mt-10 rounded-t-3xl shadow-2xl shadow-slate-900/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            {/* The Learner */}
            <div className="bg-slate-50 rounded-3xl p-8 sm:p-10 border border-slate-200 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-900/10 transition-all duration-300 group">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4">The Learner</h3>
            ...
            {/* The Educator */}
            <div className="bg-slate-50 rounded-3xl p-8 sm:p-10 border border-slate-200 hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-900/10 transition-all duration-300 group">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4">The Educator</h3>
              <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
            ...
            {/* The Researcher (Spans full width on small screens to avoid empty grid slots, normal on large) */}
            <div className="bg-slate-50 rounded-3xl p-8 sm:p-10 border border-slate-200 hover:border-indigo-300 hover:shadow-xl hover:shadow-indigo-900/10 transition-all duration-300 group sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4">The Researcher</h3>
              <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3">Marketplace & Library</h3>
              <p className="text-slate-600 text-sm sm:text-base">Buy, sell, and access a vast repository of high school revision guides, university curriculums, and advanced research papers.</p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3">Verified Experts & Tutors</h3>
              <p className="text-slate-600 text-sm sm:text-base">Book 1-on-1 virtual or local sessions with rigorously vetted academic professionals, professors, and top-tier students.</p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3">Online Assessments</h3>
              <p className="text-slate-600 text-sm sm:text-base">Test your knowledge with timed revision exams, dynamic multiple-choice quizzes, and automated grading systems.</p>
            </div>

            {/* Feature: NEW - Projects & Capstones (Spans 2 columns on small and large screens) */}
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200 sm:col-span-2 lg:col-span-2 relative overflow-hidden group">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3 relative z-10">Projects, Capstones & Final Tests</h3>
              <p className="text-slate-600 max-w-xl relative z-10 text-sm sm:text-base">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-3">Community Q&A</h3>
              <p className="text-slate-600 text-sm sm:text-base">Stuck on a complex theorem or research query? Get detailed, peer-reviewed answers from subject matter experts globally.</p>
            </div>
      ...
      <section className="bg-slate-950 py-24 relative overflow-hidden">
        ...
        {/* Clean, standard Tailwind ambient glow */}
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/3 w-96 h-96 bg-indigo-600 opacity-20 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <Link 
              href="/register" 
              className="w-full sm:w-auto px-10 py-5 bg-indigo-600 text-white font-bold rounded-2xl shadow-lg shadow-indigo-600/30 hover:bg-indigo-500 hover:scale-105 transition-all duration-300 text-xl"
            >
